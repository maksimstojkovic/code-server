...
| `N9ROUTER_PROVIDER` | `9router` | opencode provider name; models appear as `<N9ROUTER_PROVIDER>/<N9ROUTER_MODEL>` |
| `N9ROUTER_AUTO_MODELS` | `true` | Sync the full 9Router model list (`GET /models`) into opencode at startup |
...
| `LOCAL_LLM_PROVIDER` | `local` | opencode provider name for the local LLM |
